...
class Detector():
    ...
    def __init__(self,gpu_ids,placeholder=(2048,2048,3),allow_growth=False,model='model/myproject_scrdet_Frozen.pb'):
        '''
    ...
    def predict(self,file,clips = [], conf = 0.01,
                class_list = ['calss1','class2','class3'],
        ...
        for img_path in images_list:
            ...
            if file_ext in ['png','PNG','.png','.PNG']:
                if not clips:
                    ...
                    for clip in clips:
                        clip_list.append(junk[clip[0]:clip[2],clip[3]:clip[1],:])
                ...
                print('Image Format '+file_ext+' not tested yet')
                return
