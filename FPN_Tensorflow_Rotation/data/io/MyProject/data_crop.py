...
raw_images_dir = '../../../Sample_Training_Folder/train_png_files/'
raw_label_dir = '../../../Sample_Training_Folder/train_text_labels/'

# You need to make this save folder before running the script. The "labletxt" and "images" folder will get made in this folder. 
save_dir = '../../../Sample_Training_Folder/TRAIN_crop_xml/'

## This sets the crop size and step size for cropping. Pay attention to IMG_SHORT_SIDE_LEN and IMG_MAX_LENGTH in your cfgs.py file. Recommend setting img_h and img_w to same as IMG_MAX_LENGTH, where the max value in IMG_SHORT_SIDE_LEN eqauls the IMG_MAX_LENGTH. 
# img_h, img_w, stride_h, stride_w = 800, 800, 600, 600
img_h, img_w, stride_h, stride_w = 2000, 2000, 1600, 1600
